#ให้ทำโปรแกรมคำนวณหาสีที่ต้องใช้ทาด้านนอกของกล่องสี่เหลี่ยมขนาดใหญ่ 1 กล่องของทุกด้านว่าต้องใช้สีกี่แกลอนโดยให้ผู้ใช้ป้อนความกว้าง ความยาว ความสูงของกล่อง (หน่วยเป็นเมตร) ทางแป้นพิมพ์และแสดงผลจำนวนแกลอนที่ต้องใช้ทางหน้าจอ ดังนี้
#กล่องขนาดกว้าง ?? เมตร ยาว ?? เมตร ?? สูง ?? เมตร ใช้จำนวน ?? แกลอน
...
height = float(input('ความยาวของกล่อง (เมตร): '))
